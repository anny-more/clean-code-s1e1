...
var createNewTaskElement=function(taskString){
    ...
    label.classList.add('main__list');
    label.classList.add('main__task')
    //input (text)
    var editInput=document.createElement("input");//text
    editInput.classList.add('main__list-input');
    editInput.classList.add('field-hide');
    //button.edit
    ...
    //label.className='main__list main__task';
    ...
    editButton.className="main__button btn-edit";

    deleteButton.className="main__button btn-remove";
    ...
    console.log('listItem appending');
    return listItem;
}
